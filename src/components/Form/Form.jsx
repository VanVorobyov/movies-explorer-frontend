...
const Form = (props) => {
  ...
  return (
    <>
      <form action="#" method="post" className="auth__form" name="auth-form" autoComplete="off" noValidate onSubmit={onSubmit}>
        <img src={logo} alt="Логотип" className="auth__form__logo" />
        ...
        <div className="auth__form-text-wrap">
          ...
          <Link to={link} className="auth__form-link">
            {linkText}
          </Link>
        </div>
      </form>
